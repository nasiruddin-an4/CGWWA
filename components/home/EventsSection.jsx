    ...
    <section className="space-y-6">
      <div
        ...
        <div className="flex-1">
          <SectionHeader
            title="Conventions, Health Camps & Aid Distribution"
            titleBn="আসন্ন সমাবেশ, মেডিকেল ক্যাম্প ও ত্রাণ শিবির"
        ...
        <div className="shrink-0">
          <Button href="/events" variant="secondary" size="md">
            {t('View All Events & Conferences', 'সকল ইভেন্ট দেখুন')}
          </Button>
        </div>
      </div>
        ...
        <Link
          ...
          <div className="relative h-48 sm:h-56 overflow-hidden shrink-0">
            <img 
              src={evt.image} 
              alt={evt.title} 
              className="w-full h-full object-cover group-hover/evt:scale-105 transition-transform duration-700 ease-out" 
            />

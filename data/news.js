export const newsArticles= [
  {
    ...
    contentBn: [
      ...
      'এ বছর থেকে বৃত্তি কর্মসূচিতে কারিগরি ও বৃত্তিমূলক প্রশিক্ষণের অনুদানও অন্তর্ভুক্ত করা হয়েছে। ৪০০ জনের বেশি শিক্ষার্থীকে সম্পূর্ণ বিনামূল্যে সামুদ্রিক মেকানিক্স এবং আধুনিক কৃষি ডিপ্লোমা কোর্সে ভর্তি করা হয়েছে।',
      'শিক্ষকবৃন্দ জানান, এই উদ্যোগের ফলে গত তিন বছরে ঝরে পড়া শিক্ষার্থীর হার উল্লেখযোগ্যভাবে কমেছে। সংস্থাটি আগামী বছর উপকূলীয় শিক্ষার জন্য বাজেট ২০% বৃদ্ধির ঘোষণা দিয়েছে, যাতে আরও প্রত্যন্ত দ্বীপের শিক্ষার্থীরা এই সুবিধার আওতায় আসতে পারে।'
    ]
  },
  {
    id: 'news-002',
    slug: 'cyclone-readiness-medical-camp-coxs-bazar',
    title: 'Free Specialist Medical Camp & Cyclone Readiness Drive Deployed in Moheshkhali',
    titleBn: 'মহেশখালীতে বিনামূল্যে বিশেষায়িত ফ্রি মেডিকেল ক্যাম্প ও ঘুর্ণিঝড় প্রস্তুত মহড়া অনুষ্ঠিত',
    category: 'Healthcare',
  ...
  {
    id: 'news-004',
    slug: 'sundarbans-freshwater-desalination-plant',
    title: 'Commissioning of Solar-Powered Reverse Osmosis Water Plants in Shyamnagar',
    titleBn: 'শ্যামনগরে সৌরশক্তিচালিত সুপেয় পানি শোধন প্ল্যান্টের উদ্বোধন',
    category: 'Relief & Welfare',
    categoryBn: 'ত্রাণ ও কল্যাণ',
  ...
  },
  {
    ...
    content: [
      ...
      'The council concluded with a resolution to form a specialized task force dedicated to exploring blue economy potentials, focusing on sustainable seaweed farming and crab fattening cooperatives for marginalized communities.'
    ],
    contentBn: [
      'আগারগাঁওয়ে সংস্থার হেডকোয়ার্টার্স অডিটোরিয়ামে অনুষ্ঠিত বার্ষিক সাধারণ সভায় সাধারণ পর্ষদ নতুন বাজেট অনুমোদন করে।',
      'সভায় সর্বসম্মতিক্রমে রেকর্ড ৪৫ কোটি টাকার কল্যাণ বাজেট অনুমোদিত হয়, যা গত অর্থবছরের তুলনায় ২২% বেশি। বিগত বছরে কর্পোরেট সামাজিক দায়বদ্ধতা (সিএসআর) তহবিল এবং সফল কমিউনিটি ফান্ড-রেইজিংয়ের কারণে এই বাজেট বৃদ্ধি সম্ভব হয়েছে।',
      'বাজেটের অন্যতম প্রধান বরাদ্দের মধ্যে রয়েছে গভীর সমুদ্রের জেলেদের নিরাপত্তা গিয়ার কর্মসূচির সম্প্রসারণ, যার মাধ্যমে আরও ৫,০০০ জেলে নৌকাকে জিপিএস ট্র্যাকার এবং স্যাটেলাইট বিকন প্রদান করা হবে। এছাড়া দক্ষিণ উপকূলীয় অঞ্চলের বিধবা ভাতা কর্মসূচিতে নতুন ১,২০০ জন সুবিধাভোগীকে অন্তর্ভুক্ত করা হয়েছে।',
      'অর্থ পরিচালক অডিট রিপোর্ট উপস্থাপন করেন, যেখানে ৯৮% তহবিল ব্যবহারের হার প্রদর্শিত হয়, যা সংস্থার স্বচ্ছতা ও জবাবদিহিতাকে প্রমাণ করে।',
      'প্রান্তিক জনগোষ্ঠীর জন্য টেকসই সী-উইড চাষ এবং কাঁকড়া মোটাতাজাকরণ প্রকল্প বাস্তবায়নের মাধ্যমে ব্লু-ইকোনমির সম্ভাবনা কাজে লাগাতে একটি বিশেষ টাস্কফোর্স গঠনের সিদ্ধান্ত নিয়ে সভা শেষ হয়।'
    ]
  },
  {
    id: 'news-006',
    slug: 'coastal-mangrove-reforestation-drive',
    title: '100,000 Mangrove Saplings Planted in Coastal Protection Belt along Meghna Estuary',
    titleBn: 'মেঘনা মোহনায় ১ লক্ষ ম্যানগ্রোভ চারা রোপণ কার্যক্রম সফলভাবে সম্পন্ন',
    ...
    content: [
      ...
      'The Department of Environment has officially recognized this initiative, pledging technical support for the next phase, which aims to plant an additional 250,000 trees by the end of 2027.'
    ],
    contentBn: [
      'নদী ভাঙন রোধে ১৮ কিলোমিটার রিং-বাঁধে ম্যানগ্রোভ গাছের সবুজ দেয়াল তৈরি কার্যক্রমে বিপুল সংখ্যক ছাত্র-শিক্ষক অংশ নেন।',
      'তিন সপ্তাহব্যাপী এই উদ্যোগে ভোলা ও লক্ষ্মীপুর জেলার ঝুঁকিপূর্ণ মেঘনা মোহনায় কেওড়া, বাইন এবং গেওয়া প্রজাতির ১ লক্ষেরও বেশি ম্যানগ্রোভ চারা রোপণ করা হয়।',
      'এই বিশাল পরিবেশগত উদ্যোগে ৫,০০০ স্থানীয় উচ্চ বিদ্যালয়ের শিক্ষার্থী, আঞ্চলিক কোস্ট গার্ড সদস্য এবং স্থানীয় কৃষকরা অংশগ্রহণ করেন। কমিউনিটির প্রত্যক্ষ অংশগ্রহণের ফলে এই চারাগুলোর দীর্ঘমেয়াদী বেঁচে থাকার সম্ভাবনা বহুগুণ বৃদ্ধি পেয়েছে।',
      'ম্যানগ্রোভ বন ঘূর্ণিঝড় মৌসুমে জলোচ্ছ্বাসের বিরুদ্ধে প্রথম স্তরের প্রাকৃতিক প্রতিরক্ষা হিসেবে কাজ করে, যা ঢেউয়ের শক্তি প্রশমিত করে এবং মাটি ক্ষয় রোধ করে। দুর্যোগ ঝুঁকি হ্রাসের পাশাপাশি এই নতুন বনাঞ্চল মাছ ও কাঁকড়ার প্রজনন ক্ষেত্র হিসেবে কাজ করবে, যা স্থানীয় জীববৈচিত্র্য রক্ষা করবে।',
      'পরিবেশ অধিদপ্তর এই উদ্যোগের প্রশংসা করেছে এবং পরবর্তী ধাপের জন্য কারিগরি সহায়তার প্রতিশ্রুতি দিয়েছে, যার লক্ষ্য ২০২৭ সালের মধ্যে আরও ২,৫০,০০০ চারা রোপণ করা।'
    ]
  }
];
